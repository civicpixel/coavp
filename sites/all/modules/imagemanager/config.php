<?php
	...
	$mcImageManagerConfig['filesystem.path'] = '../../../default/files'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../default/files'; // absolute or relative from this script path, required.
	...
	// Authenication
	$mcImageManagerConfig['authenticator'] = "DrupalAuthenticator";
